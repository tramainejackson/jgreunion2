            ...
            <div class="card border border-1 px-0">
                ...
                <div class="card-header bg-success-subtle text-center">
                    <h1 class="" style="color: navy;">Completed Registration
                        for Upcoming Reunion
                        in {{ $active_reunion->reunion_city . ', ' . $active_reunion->reunion_state . ' ' . $active_reunion->reunion_year  }} </h1>
                </div>
                ...
                <div class="card-footer">
                    <div class="row align-content-center justify-content-center" id="">
                        <div class="col mx-auto text-center" id="">
                            <p class="">If you have any question or need to make any adjustments to your registration, please send an email to <a
                                    href="mailto:jacksongreenreunion@gmail.com">jacksongreenreunion@gmail.com</a></p>
                        </div>
                    </div>
                </div>
            </div>
