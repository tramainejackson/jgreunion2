...
<head>
    ...
    <title>New Profile Account</title>
    <!--[if (mso 16)]>
    <style>
        a {
                                                        ...
                                                        <tr style="border-collapse:collapse;">
                                                            <td align="left"
                                                                style="padding:0;Margin:0;padding-top:20px;"><p
                                                                    ...
                                                                    Thank you for creating a new account on the family
                                                                    reunion website. We will take a look at the
                                                                    registration and email you when the account is
                                                                    approved. If you have any questions please feel
                                                                    free to
                                                            ...
                                                            <td align="left"
                                                                ...
                                                                <ul style="list-style: none; padding-left: 0px;">
                                                                    <li style="margin-left: 0px;">
                                                                        <span
                                                                            style="text-decoration: underline; font-weight: bold; Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:14px;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;">Name:</span><span
                                                                            style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:14px;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;"> {{ ucwords($member->firstname . ' ' . $member->lastname) }}
                                                                        </span>
                                                                    </li>

                                                                    <li style="margin-left: 0px;">
                                                                        <span style="text-decoration: underline; font-weight: bold; Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:14px;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;">Username:</span>
                                                                        <span style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:14px;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;"> {{ $user->username != null ? $user->username : 'No Email Address Added' }}</span>
                                                                    </li>
                                                                </ul>
                                                            </td>
                                                        </tr>
