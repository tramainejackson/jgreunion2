            ...
            <div class="col-11 col-lg-8 membersForm mx-auto">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-4">
                        ...
                        <input type="number" name="zip" class="form-control" max="99999" value="{{  old('zip') }}"
                ...
                <div class="form-group">
                    ...
                    <select class="form-control browser-default" name="mail_preference">
                        <option value="M" {{ old('mail_preference') && old('mail_preference') == 'M' ? 'selected' : '' }}>
                            Mail
                        </option>
                        <option value="E" {{ old('mail_preference') && old('mail_preference') == 'E' ? 'selected' : '' }}>
                            Email
                        </option>
                    </select>
                </div>
