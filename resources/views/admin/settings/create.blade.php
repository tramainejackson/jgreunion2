            ...
            <div class="col-8 reunionForm">
                ...
                <div class="form-row">
                    <div class="form-group col-6">
                        ...
                        <input type="text" name="reunion_city" class="form-control" value="{{  old('reunion_city') }}"
                    ...
                    <div class="form-group col-6">
                        ...
                        <select class="form-control" name="reunion_state">
                            @foreach($states as $state)
                                <option
                                    value="{{ $state->state_abb }}" {{ old('reunion_state') && old('reunion_state') == $state->state_abb ? 'selected' : '' }}>{{ $state->state_name }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <select class="form-control" name="reunion_year">
                        @foreach($years as $year)
                            <option
                                value="{{ $year->year_num }}" {{ old('reunion_year') && old('reunion_year') == $year->year_num ? 'selected' : '' }}>{{ $year->year_num }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="form-block-header">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" name="adult_price" class="form-control" value="{{ old('adult_price') }}"
                               step="0.01" placeholder="Price For Adult 18-Older"/>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" name="youth_price" class="form-control" value="{{ old('youth_price') }}"
                               step="0.01" placeholder="Price For Youth 4-18"/>
                        <div class="input-group-append">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" name="child_price" class="form-control" value="{{ old('child_price') }}"
                               aria-label="Username" aria-describedby="basic-addon1" step="0.01"
                ...
                <div class="form-block-header">
                    <h3 class="">Committee
                        <button type="button" class="btn btn-outline-success mb-2 addCommitteeMember">Add Committee
                            Member
                        </button>
                    </h3>
                </div>
