                ...
                @if($registration->family_member_id != null)
                    <div class="form-group">
                        ...
                        <input type="text" name="address" class="form-control"
                               value="{{ $registration->reunion_dl->address }}" placeholder="Enter Address" disabled/>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-4">
                            <label class="form-label" for="city">City</label>
                            <input type="text" name="city" class="form-control"
                                   value="{{ $registration->reunion_dl->city }}" placeholder="Enter City" disabled/>
                        </div>
                        <div class="form-group col-4">
                        ...
                        <div class="form-group col-4">
                            ...
                            <input type="number" name="zip" class="form-control"
                                   value="{{ $registration->reunion_dl->zip }}" placeholder="Enter Zip Code" disabled/>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-6">
                            ...
                            <input type="text" name="email" class="form-control"
                                   value="{{ $registration->reunion_dl->email }}" placeholder="Enter Email Address"
                                   disabled/>
                        </div>
                        <div class="form-group col-6">
                            <label class="form-label" for="phone">Phone</label>
                            <input type="number" name="phone" class="form-control"
                                   value="{{ old('phone') ? old('phone') : $registration->reunion_dl->phone }}"
                                        ...
                                        <div class="my-1">
                                            <div class="input-group">
                                                ...
                                                <div class="input-group-append">
                                                    <button class="btn btn-outline-danger removeRegIndividualBtn{{ $family_reg == $registration->reunion_dl->firstname ? ' disabled' : '' }}"
                                                            type="button"
                                                            onclick="remove_from_reg('{{ $registration->id }}', 'adult{{ $loop->iteration }}')" {{ $family_reg == $registration->reunion_dl->firstname ? ' disabled' : '' }}>
                                                        Remove
                                                    </button>
                                                </div>
                                            </div>
                                            ...
                                            <select class="browser-default form-control my-1" name="adult_sizes[]">
                                                <option value="S" {{ isset($adultSizes[$loop->iteration - 1]) ? $adultSizes[$loop->iteration - 1] == 'S' ? 'selected' : '' : ' '}}>
                                                    Small
                                                </option>
                                                <option value="M" {{ isset($adultSizes[$loop->iteration - 1]) ? $adultSizes[$loop->iteration - 1] == 'M' ?  'selected' : ''  : '' }}>
                                                    Medium
                                                </option>
                                                <option value="L" {{ isset($adultSizes[$loop->iteration - 1]) ? $adultSizes[$loop->iteration - 1] == 'L' ?  'selected' : '' : '' }}>
                                                    Large
                                                </option>
                                                <option value="XL" {{ isset($adultSizes[$loop->iteration - 1]) ? $adultSizes[$loop->iteration - 1] == 'XL' ?  'selected' : '' : '' }}>
                                                    Extra Large
                                                </option>
                                                <option value="XXL" {{ isset($adultSizes[$loop->iteration - 1]) ? $adultSizes[$loop->iteration - 1] == 'XXL' ?  'selected' : '' : '' }}>
                                                    2XL
                                                </option>
                                                <option value="XXXL" {{ isset($adultSizes[$loop->iteration - 1]) ? $adultSizes[$loop->iteration - 1] == 'XXXL' ?  'selected' : '' : '' }}>
                                                    3XL
                                                </option>
                                            </select>
                                        </div>
                                    ...
                                    @if($family_reg != '' || $family_reg != null)
                                        <div class="my-1">
                                            ...
                                            <select class="browser-default form-control my-1" name="youth_sizes[]">
                                                <option value="S" {{ isset($youthSizes[$loop->iteration - 1]) ? $youthSizes[$loop->iteration - 1] == 'S' ? 'selected' : '' : ' '}}>
                                                    Youth XSmall
                                                </option>
                                                <option value="M" {{ isset($youthSizes[$loop->iteration - 1]) ? $youthSizes[$loop->iteration - 1] == 'M' ?  'selected' : ''  : '' }}>
                                                    Youth Small
                                                </option>
                                                <option value="L" {{ isset($youthSizes[$loop->iteration - 1]) ? $youthSizes[$loop->iteration - 1] == 'L' ?  'selected' : '' : '' }}>
                                                    Youth Medium
                                                </option>
                                                <option value="XL" {{ isset($youthSizes[$loop->iteration - 1]) ? $youthSizes[$loop->iteration - 1] == 'XL' ?  'selected' : '' : '' }}>
                                                    Youth Large
                                                </option>
                                                <option value="XXL" {{ isset($youthSizes[$loop->iteration - 1]) ? $youthSizes[$loop->iteration - 1] == 'XXL' ?  'selected' : '' : '' }}>
                                                    Adult Small
                                                </option>
                                                <option value="XXXL" {{ isset($youthSizes[$loop->iteration - 1]) ? $youthSizes[$loop->iteration - 1] == 'XXXL' ?  'selected' : '' : '' }}>
                                                    Adult Large
                                                </option>
                                            </select>
                                        </div>
                                    ...
                                    @if($family_reg != '' || $family_reg != null)
                                        <div class="my-1">
                                            ...
                                            <select class="browser-default form-control my-1" name="children_sizes[]">
                                                <option value="S" {{ isset($childrenSizes[$loop->iteration - 1]) ? $childrenSizes[$loop->iteration - 1] == 'S' ? 'selected' : '' : ' '}}>
                                                    12 Months
                                                </option>
                                                <option value="M" {{ isset($childrenSizes[$loop->iteration - 1]) ? $childrenSizes[$loop->iteration - 1] == 'M' ?  'selected' : ''  : '' }}>
                                                    2T
                                                </option>
                                                <option value="L" {{ isset($childrenSizes[$loop->iteration - 1]) ? $childrenSizes[$loop->iteration - 1] == 'L' ?  'selected' : '' : '' }}>
                                                    3T
                                                </option>
                                                <option value="XL" {{ isset($childrenSizes[$loop->iteration - 1]) ? $childrenSizes[$loop->iteration - 1] == 'XL' ?  'selected' : '' : '' }}>
                                                    4T
                                                </option>
                                                <option value="XXL" {{ isset($childrenSizes[$loop->iteration - 1]) ? $childrenSizes[$loop->iteration - 1] == 'XXL' ?  'selected' : '' : '' }}>
                                                    5T
                                                </option>
                                                <option value="XXXL" {{ isset($childrenSizes[$loop->iteration - 1]) ? $childrenSizes[$loop->iteration - 1] == 'XXXL' ?  'selected' : '' : '' }}>
                                                    6
                                                </option>
                                            </select>
                                        </div>
