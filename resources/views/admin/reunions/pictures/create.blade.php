...
@section('content')
    <div class="container-fluid" id="">
                ...
                <div class="">
                    ...
                    @if($reunion->reunion_complete == 'N')
                        ...
                        <a href="{{ route('reunions.edit', ['reunion' => $reunion->id]) }}"
                           class="btn btn-lg btn-block btn-outline-primary">Edit {{ $reunion->reunion_city . ' ' . $reunion->reunion_year }}
                            Reunion</a>
                    ...
                    <div class="file-field">
                        ...
                        <div class="file-path-wrapper">
                            <input class="file-path validate" type="text"
                                   placeholder="Upload Up To 10 Pictures At A Time"/>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="col-4 my-1">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body text-center">
                                        ...
                                        <!--Input-->
                                        <div class="md-form">
                                            <textarea name="description" class="md-textarea form-control"
                                                      placeholder="Enter A Description For The Picture">{{ $image->description }}</textarea>
                                        </div>
                                        ...
                                        <button class="btn btn-danger deleteCarousel" type="button" data-toggle="modal"
                                                data-target="#pictureConfirmDelete">Delete
                                        </button>
                                    </div>
        ...
        <div class="modal fade" id="pictureConfirmDelete" tabindex="-1" role="dialog"
