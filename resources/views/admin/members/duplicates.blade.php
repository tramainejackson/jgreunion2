            ...
            <div class="col-12 col-md-10 mx-auto my-2 duplicatesCol animated">
                ...
                @if($duplicates_check !== null)
                    ...
                    @foreach($duplicates_check as $duplicate)
                        @php
                            $firstAccount = App\Models\FamilyMember::getDuplicates($duplicate->firstname, $duplicate->lastname, $duplicate->city, $duplicate->state)->first();
                        @endphp
                        ...
                        <div class="card grey lighten-1 my-2 animated">
                            ...
                            <div class="d-flex flex-center justify-content-center my-3">
                                ...
                                <div class="mx-4">
                                    <img
                                        src="{{ asset($duplicate->avatar ? $duplicate->avatar : '/images/img_placeholder.jpg' ) }}"
                                        class="img-fluid" height="350px" width="250px"/>
                                </div>

                                <!-- Bio Info -->
                                <div class="mx-4">
                                    <h3 class="h3-responsive"><span class="font-weight-bold pr-3">Name:</span><span
                                            class="text-muted">{{ $firstAccount->full_name() }}</span></h3>

                                    <h3 class="h3-responsive"><span class="font-weight-bold pr-3">Address:</span><span
                                            class="text-muted">{{ $firstAccount->full_address() }}</span></h3>

                                    <h3 class="h3-responsive"><span class="font-weight-bold pr-3">Email:</span><span
                            ...
                            <div class="card-body text-center">
                                @foreach(App\Models\FamilyMember::getDuplicates($duplicate->firstname, $duplicate->lastname, $duplicate->city, $duplicate->state)->get() as $dupe)
                                    ...
                                    @if($loop->iteration != 1)
                                        ...
                                        <div class="container-fluid animated">
                                            ...
                                            <div
                                                ...
                                                <div
                                                    class="d-flex flex-column align-items-center justify-content-around flex-xl-row col-12 col-xl-4">

                                                    <button class="btn btn-rounded red lighten-1 deleteDupe"
                                                            type="button">Delete
                                                        <input type="text" class="hidden" value="{{ $dupe->id }}"
                                                               hidden/>
                                                    </button>

                                                    <button class="btn btn-rounded orange accent-1 keepDupe"
